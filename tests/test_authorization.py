...
class TestAuthorization:
    ...
    def test_check(self, workos, httpx_mock):
        ...
        assert request.method == "POST"
        assert request.url.path.endswith(
            "/authorization/organization_memberships/test_organization_membership_id/check"
        )
        body = json.loads(request.content)
    ...
    def test_list_resources_for_membership_encodes_query_params(
        ...
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_resources_for_membership(
            "test_organization_membership_id",
            parent_resource=ParentResourceById(
                parent_resource_id="value parent_resource_id/test"
            ),
            limit=10,
            before="cursor before",
            after="cursor/after",
        ...
        request = httpx_mock.get_request()
        assert (
            request.url.params["parent_resource_id"] == "value parent_resource_id/test"
        )
        assert request.url.params["limit"] == "10"
        assert request.url.params["before"] == "cursor before"
        assert request.url.params["after"] == "cursor/after"
    ...
    def test_list_effective_permissions(self, workos, httpx_mock):
        ...
        page = workos.authorization.list_effective_permissions(
    ...
    def test_list_effective_permissions_encodes_query_params(self, workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_effective_permissions(
            "test_organization_membership_id",
            "test_resource_id",
            limit=10,
            before="cursor before",
    ...
    def test_list_effective_permissions_by_external_id(self, workos, httpx_mock):
        ...
        page = workos.authorization.list_effective_permissions_by_external_id(
            "test_organization_membership_id",
    ...
    def test_list_effective_permissions_by_external_id_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_effective_permissions_by_external_id(
            "test_organization_membership_id",
            "test_resource_type_slug",
            "test_external_id",
            limit=10,
    ...
    def test_list_role_assignments(self, workos, httpx_mock):
        httpx_mock.add_response(
            json=load_fixture("list_user_role_assignment.json"),
        )
        page = workos.authorization.list_role_assignments(
            "test_organization_membership_id"
        )
        assert isinstance(page, SyncPage)
        assert len(page.data) == 1
        assert isinstance(page.data[0], UserRoleAssignment)
    ...
    def test_list_role_assignments_encodes_query_params(self, workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_role_assignments(
            "test_organization_membership_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    def test_assign_role(self, workos, httpx_mock):
        httpx_mock.add_response(
            json=load_fixture("user_role_assignment.json"),
        )
    ...
    def test_remove_role_assignment(self, workos, httpx_mock):
        httpx_mock.add_response(status_code=204)
        result = workos.authorization.remove_role_assignment(
    ...
    def test_get_resource_by_external_id(self, workos, httpx_mock):
        ...
        result = workos.authorization.get_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        ...
        assert request.method == "GET"
        assert request.url.path.endswith(
            "/authorization/organizations/test_organization_id/resources/test_resource_type_slug/test_external_id"
        )
    ...
    def test_update_resource_by_external_id(self, workos, httpx_mock):
        ...
        result = workos.authorization.update_resource_by_external_id(
    ...
    def test_delete_resource_by_external_id(self, workos, httpx_mock):
        httpx_mock.add_response(status_code=204)
        result = workos.authorization.delete_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        assert result is None
        request = httpx_mock.get_request()
    ...
    def test_delete_resource_by_external_id_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(status_code=204)
        workos.authorization.delete_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            cascade_delete=True,
    ...
    def test_list_memberships_for_resource_by_external_id_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_memberships_for_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            limit=10,
    ...
    def test_list_role_assignments_for_resource_by_external_id(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(
            json=load_fixture("list_user_role_assignment.json"),
        )
        page = workos.authorization.list_role_assignments_for_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        assert isinstance(page, SyncPage)
        assert len(page.data) == 1
    ...
    def test_list_role_assignments_for_resource_by_external_id_empty_page(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = workos.authorization.list_role_assignments_for_resource_by_external_id(
    ...
    def test_list_role_assignments_for_resource_by_external_id_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_role_assignments_for_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            limit=10,
    ...
    def test_list_resources_encodes_query_params(self, workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_resources(
            parent=ParentById(parent_resource_id="value parent_resource_id/test"),
            limit=10,
            before="cursor before",
            after="cursor/after",
            order=PaginationOrder("value_order"),
    ...
    def test_list_memberships_for_resource_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_memberships_for_resource(
            "test_resource_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    def test_list_role_assignments_for_resource(self, workos, httpx_mock):
        httpx_mock.add_response(
            json=load_fixture("list_user_role_assignment.json"),
        )
        page = workos.authorization.list_role_assignments_for_resource(
            "test_resource_id"
        )
        assert isinstance(page, SyncPage)
        assert len(page.data) == 1
    ...
    def test_list_role_assignments_for_resource_empty_page(self, workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = workos.authorization.list_role_assignments_for_resource(
            "test_resource_id"
        )
    ...
    def test_list_role_assignments_for_resource_encodes_query_params(
        self, workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_role_assignments_for_resource(
            "test_resource_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    def test_create_environment_role(self, workos, httpx_mock):
        ...
        result = workos.authorization.create_environment_role(
    ...
    def test_list_permissions_encodes_query_params(self, workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        workos.authorization.list_permissions(
            limit=10,
            before="cursor before",
            after="cursor/after",
            order=PaginationOrder("value_order"),
    ...
    def test_create_permission(self, workos, httpx_mock):
        ...
        result = workos.authorization.create_permission(
            slug="test_slug", name="test_name"
        )
...
class TestAsyncAuthorization:
    ...
    @pytest.mark.asyncio
    async def test_list_resources_for_membership_empty_page(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = await async_workos.authorization.list_resources_for_membership(
    ...
    @pytest.mark.asyncio
    async def test_list_resources_for_membership_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_resources_for_membership(
            "test_organization_membership_id",
            parent_resource=ParentResourceById(
                parent_resource_id="value parent_resource_id/test"
            ),
    ...
    @pytest.mark.asyncio
    async def test_list_effective_permissions_empty_page(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = await async_workos.authorization.list_effective_permissions(
    ...
    @pytest.mark.asyncio
    async def test_list_effective_permissions_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
    ...
    @pytest.mark.asyncio
    async def test_list_effective_permissions_by_external_id(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json=load_fixture("list_authorization_permission.json"))
        page = (
            await async_workos.authorization.list_effective_permissions_by_external_id(
                "test_organization_membership_id",
                "test_resource_type_slug",
                "test_external_id",
            )
    ...
    @pytest.mark.asyncio
    async def test_list_effective_permissions_by_external_id_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_effective_permissions_by_external_id(
    ...
    async def test_list_role_assignments(self, async_workos, httpx_mock):
        httpx_mock.add_response(json=load_fixture("list_user_role_assignment.json"))
        page = await async_workos.authorization.list_role_assignments(
            "test_organization_membership_id"
        )
        assert isinstance(page, AsyncPage)
        assert len(page.data) == 1
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_role_assignments(
            "test_organization_membership_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    async def test_assign_role(self, async_workos, httpx_mock):
        httpx_mock.add_response(json=load_fixture("user_role_assignment.json"))
    ...
    async def test_remove_role_assignment(self, async_workos, httpx_mock):
        httpx_mock.add_response(status_code=204)
        result = await async_workos.authorization.remove_role_assignment(
            "test_organization_membership_id", "test_role_assignment_id"
        )
        assert result is None
        request = httpx_mock.get_request()
    ...
    async def test_get_resource_by_external_id(self, async_workos, httpx_mock):
        ...
        result = await async_workos.authorization.get_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        assert isinstance(result, AuthorizationResource)
        assert result.object == "authorization_resource"
    ...
    async def test_update_resource_by_external_id(self, async_workos, httpx_mock):
        httpx_mock.add_response(json=load_fixture("authorization_resource.json"))
        result = await async_workos.authorization.update_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            parent_resource=ParentResourceById(parent_resource_id="test_value"),
    ...
    async def test_delete_resource_by_external_id(self, async_workos, httpx_mock):
        httpx_mock.add_response(status_code=204)
        result = await async_workos.authorization.delete_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        assert result is None
        request = httpx_mock.get_request()
    ...
    @pytest.mark.asyncio
    async def test_delete_resource_by_external_id_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(status_code=204)
        await async_workos.authorization.delete_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            cascade_delete=True,
    ...
    @pytest.mark.asyncio
    async def test_list_memberships_for_resource_by_external_id(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(
            json=load_fixture("list_user_organization_membership_base_list_data.json")
    ...
    @pytest.mark.asyncio
    async def test_list_memberships_for_resource_by_external_id_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource_by_external_id(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json=load_fixture("list_user_role_assignment.json"))
        page = await async_workos.authorization.list_role_assignments_for_resource_by_external_id(
            "test_organization_id", "test_resource_type_slug", "test_external_id"
        )
        assert isinstance(page, AsyncPage)
        assert len(page.data) == 1
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource_by_external_id_empty_page(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = await async_workos.authorization.list_role_assignments_for_resource_by_external_id(
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource_by_external_id_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_role_assignments_for_resource_by_external_id(
            "test_organization_id",
            "test_resource_type_slug",
            "test_external_id",
            limit=10,
    ...
    async def test_list_resources_encodes_query_params(self, async_workos, httpx_mock):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_resources(
            parent=ParentById(parent_resource_id="value parent_resource_id/test"),
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    @pytest.mark.asyncio
    async def test_list_memberships_for_resource_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_memberships_for_resource(
            "test_resource_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource(self, async_workos, httpx_mock):
        httpx_mock.add_response(json=load_fixture("list_user_role_assignment.json"))
        page = await async_workos.authorization.list_role_assignments_for_resource(
            "test_resource_id"
        )
        assert isinstance(page, AsyncPage)
        assert len(page.data) == 1
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource_empty_page(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        page = await async_workos.authorization.list_role_assignments_for_resource(
    ...
    @pytest.mark.asyncio
    async def test_list_role_assignments_for_resource_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_role_assignments_for_resource(
            "test_resource_id",
            limit=10,
            before="cursor before",
            after="cursor/after",
    ...
    async def test_create_environment_role(self, async_workos, httpx_mock):
        httpx_mock.add_response(json=load_fixture("role.json"))
        result = await async_workos.authorization.create_environment_role(
            slug="test_slug", name="test_name"
        )
        assert isinstance(result, Role)
        assert result.slug == "admin"
    ...
    @pytest.mark.asyncio
    async def test_list_permissions_encodes_query_params(
        self, async_workos, httpx_mock
    ):
        httpx_mock.add_response(json={"data": [], "list_metadata": {}})
        await async_workos.authorization.list_permissions(
            limit=10,
            before="cursor before",
            after="cursor/after",
            order=PaginationOrder("value_order"),
    ...
    async def test_create_permission(self, async_workos, httpx_mock):
        ...
        result = await async_workos.authorization.create_permission(
            slug="test_slug", name="test_name"
        )
        assert isinstance(result, Permission)
        assert result.object == "permission"
